			...
			<form class="form-horizontal" method="POST" action="{{ route('event.update', [$event->id]) }}" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-md-10 col-md-offset-2">
						<img src="{{ $event->path_to_hero_picture }}" width="60" height="60">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('theme') ? ' has-error' : '' }}">
					...
					<div class="col-md-10">
						<input id="theme" type="text" name="theme" class="form-control" value="{{ $event->theme }}" required autofocus="autofocus" />
						@if ($errors->has('theme'))
	                        <span class="help-block">
